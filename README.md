...
#### If you want to expand the range of services provided by your restaurant using the website for ordering five meals a day delivery, write to the email specified in the team leader's [GitHub profile](https://github.com/imgVOID). This software product uses only professional, save and reliable software technologies like Python Django, REST API, social authentication by JWT (Google Auth), any language internationalization and localization.
