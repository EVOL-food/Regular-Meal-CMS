...
##### This software product uses only professional, save and reliable software technologies like Python Django, REST API, social authentication by JWT (Google Auth), any language internationalization and localization.
